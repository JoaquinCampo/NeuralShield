"""Test Mahalanobis distance detector (EllipticEnvelope) on precomputed embeddings."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Test Mahalanobis (EllipticEnvelope) on embeddings"
    )
    ...
    if args.wandb:
        ...
        wandb.init(
            ...
            name=args.wandb_run_name or "mahalanobis-test",
            config={
                "detector": "empirical_covariance_mahalanobis",
    ...
    logger.info("=" * 80)
    test_scores = detector.mahalanobis(test_embeddings)
