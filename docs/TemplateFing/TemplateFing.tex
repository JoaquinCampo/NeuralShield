...
% supervisor
\supervisor{Rodrigo Martinez}                

% cosupervisor (comentar si no tiene)
\cosupervisor{Gustavo Betarte}
...
\subsubsubsection{Normalizar y agregar flags de rarezas}
...
\subsubsubsection{Construir URL absoluta cuando es relativa}
